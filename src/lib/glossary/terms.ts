...
export const GLOSSARY_TERMS: GlossaryTerm[] = ([
  ...
  // ===== ADDITIONAL TERMS FROM RESEARCH =====
  {
    id: "accion-reivindicatoria",
    term: "Acción Reivindicatoria",
    category: "derechos_reales",
    simpleDefinition: "Acción que ejerce el verdadero dueño de un bien para recuperarlo de quien lo tiene sin derecho. Es la herramienta legal más importante para defender la propiedad.",
    legalDefinition: "Acción real que compete al propietario no poseedor contra el poseedor no propietario, para obtener la restitución de la cosa mediante la demostración del derecho de dominio y la identificación del bien reclamado.",
    example: "El demandante, acreditando su derecho propietario mediante escritura pública registrada en Derechos Reales, ejerce la acción reivindicatoria conforme al Art. 1453 del Código Civil contra el ocupante ilegítimo del inmueble.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 70, articles: ["1453", "1454", "1455", "1456", "1457", "1458"] },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 25 },
      { law: "Constitución Política del Estado", shortName: "CPE", percentage: 5 },
    ],
    relatedTerms: ["derecho-real", "posesion", "usucapion"],
  },
  {
    id: "arras",
    term: "Arras",
    category: "contratos",
    simpleDefinition: "Dinero que se entrega al firmar un acuerdo como señal de compromiso. Si quien las dio se arrepiente, las pierde; si se arrepiente quien las recibió, debe devolverlas duplicadas.",
    legalDefinition: "Suma de dinero o cosa fungible que una parte entrega a la otra al momento de la celebración del contrato, pudiendo tener carácter confirmatorio (prueba de celebración y anticipo del precio) o penitencial (facultad de retractación mediante su pérdida o restitución del doble).",
    example: "LA COMPRADORA entrega a LA VENDEDORA la suma de Bs. 10,000 en calidad de arras confirmatorias, conforme al Art. 537 del Código Civil, las cuales serán imputadas al precio total de la compraventa.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 90, articles: ["537", "538", "539", "540"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
    ],
    relatedTerms: ["clausula-penal", "resolucion", "compraventa"],
  },
  {
    id: "aval",
    term: "Aval",
    category: "comercial",
    simpleDefinition: "Firma de garantía en un documento de pago (pagaré, letra de cambio) por la cual el avalista se compromete a pagar si el deudor principal no lo hace. Es diferente de la fianza porque es autónoma.",
    legalDefinition: "Garantía cambiaria autónoma, unilateral e independiente, otorgada por un tercero o por un signatario del título valor, mediante la cual el avalista se obliga solidariamente al pago de la obligación contenida en el documento, en los mismos términos que el avalado.",
    example: "Don Juan Pérez se constituye en avalista solidario del pagaré No. 001/2026, garantizando el pago íntegro de $us. 5,000 a favor del tenedor legítimo, conforme a los Arts. 630 y siguientes del Código de Comercio.",
    lawPresence: [
      { law: "Código de Comercio", shortName: "CCom", percentage: 85, articles: ["630", "631", "632", "633", "634", "635", "636", "637", "638", "639", "640"] },
      { law: "Código Civil", shortName: "CC", percentage: 5 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
    ],
    relatedTerms: ["endoso", "protesto", "titulo-valor", "fianza"],
  },
  {
    id: "compensacion",
    term: "Compensación",
    category: "obligaciones",
    simpleDefinition: "Cuando dos personas se deben mutuamente dinero, las deudas se cancelan entre sí hasta donde alcancen. Si A le debe 50,000 a B, y B le debe 30,000 a A, solo queda una deuda de 20,000 de A hacia B.",
    legalDefinition: "Modo de extinción de las obligaciones que opera cuando dos personas reúnen recíprocamente la calidad de acreedor y deudor, extinguiéndose ambas deudas hasta la concurrencia de la menor, siempre que sean homogéneas, líquidas y exigibles.",
    example: "Siendo que el primer contratante adeuda Bs. 50,000 y el segundo le adeuda Bs. 30,000, ambas deudas líquidas y exigibles, opera la compensación legal conforme al Art. 363 del Código Civil, subsistiendo solo Bs. 20,000.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 80, articles: ["363", "364", "365", "366", "367", "368", "369", "370", "371"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 10 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
      { law: "Ley General del Trabajo", shortName: "LGT", percentage: 5 },
    ],
    relatedTerms: ["novacion", "subrogacion", "prescripcion"],
  },
  {
    id: "concordato",
    term: "Concordato",
    category: "comercial",
    simpleDefinition: "Acuerdo entre un comerciante en quiebra y sus acreedores para pagar las deudas de forma reducida o con plazos más largos, evitando la liquidación total del negocio.",
    legalDefinition: "Convenio judicial celebrado entre el deudor comerciante en estado de cesación de pagos y la mayoría calificada de sus acreedores, aprobado y homologado por el juez, mediante el cual se establecen condiciones de pago (quitas, esperas) para la satisfacción de los créditos.",
    example: "El deudor propone a sus acreedores un concordato preventivo consistente en una quita del 30% y una espera de 24 meses para el pago del saldo, conforme a los Arts. 1550 y siguientes del Código de Comercio.",
    lawPresence: [
      { law: "Código de Comercio", shortName: "CCom", percentage: 80, articles: ["1550", "1551", "1552", "1560", "1570", "1600"] },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 10 },
      { law: "Código Civil", shortName: "CC", percentage: 5 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
    ],
    relatedTerms: ["titulo-valor", "letra-de-cambio"],
  },
  {
    id: "condicion-suspensiva",
    term: "Condición Suspensiva",
    category: "obligaciones",
    simpleDefinition: "Cuando los efectos de un contrato no comienzan hasta que ocurra algo futuro e incierto. Por ejemplo: 'te compro la casa si me aprueban el crédito bancario'. Si no aprueban el crédito, no hay compra.",
    legalDefinition: "Modalidad del acto jurídico consistente en un acontecimiento futuro e incierto del cual las partes hacen depender el nacimiento o la eficacia de la obligación. Solo se perfecciona y produce efectos cuando la condición se cumple.",
    example: "La obligación de transferir el inmueble queda sujeta a condición suspensiva consistente en la aprobación del crédito hipotecario, conforme al Art. 494 del Código Civil. Si el crédito no se aprueba, el contrato no surte efectos.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 85, articles: ["494", "495", "496", "497", "498", "499", "500", "508"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 10 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
    ],
    relatedTerms: ["plazo", "clausula-penal", "resolucion"],
  },
  {
    id: "dacion-en-pago",
    term: "Dación en Pago",
    category: "obligaciones",
    simpleDefinition: "Cuando el deudor, con aceptación del acreedor, paga su deuda entregando algo diferente a lo que debía originalmente. Por ejemplo, entregar un auto en vez de dinero.",
    legalDefinition: "Modo de extinción de las obligaciones por el cual el deudor, con el consentimiento del acreedor, cumple su prestación mediante la entrega de una cosa distinta a la originalmente debida, produciendo los efectos del pago.",
    example: "Las partes convienen en la dación en pago del vehículo marca Hyundai, valorado de mutuo acuerdo en Bs. 120,000, en cancelación total de la deuda conforme al Art. 307 del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 85, articles: ["307", "308", "309"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
    ],
    relatedTerms: ["compensacion", "novacion", "mora"],
  },
  {
    id: "embargo",
    term: "Embargo",
    category: "procesal",
    simpleDefinition: "Orden del juez que 'congela' bienes del deudor para que no los venda ni esconda, asegurando que haya con qué pagarle al acreedor cuando salga la sentencia.",
    legalDefinition: "Medida cautelar o ejecutiva por la cual la autoridad judicial ordena la afectación de bienes determinados del patrimonio del deudor, inmovilizándolos jurídicamente para asegurar el resultado del proceso (embargo preventivo) o para satisfacer el crédito ejecutado (embargo ejecutivo).",
    example: "Se decreta embargo preventivo sobre la cuenta bancaria del demandado hasta por Bs. 200,000, a fin de garantizar las resultas del presente proceso ordinario de cobro.",
    lawPresence: [
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 55, articles: ["310", "311", "312", "313", "314", "315", "404", "405"] },
      { law: "Código Civil", shortName: "CC", percentage: 20 },
      { law: "Código de Comercio", shortName: "CCom", percentage: 10 },
      { law: "Ley General del Trabajo", shortName: "LGT", percentage: 10 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
    ],
    relatedTerms: ["sentencia", "prescripcion", "cosa-juzgada"],
  },
  {
    id: "enriquecimiento-sin-causa",
    term: "Enriquecimiento sin Causa",
    category: "obligaciones",
    simpleDefinition: "Cuando alguien se beneficia económicamente a costa de otro sin razón legal que lo justifique. El perjudicado puede pedir que le devuelvan lo que corresponde.",
    legalDefinition: "Fuente autónoma de obligaciones que se configura cuando una persona obtiene un incremento patrimonial a expensas de otra sin causa jurídica que lo justifique, generando la obligación de restituir el menor valor entre el enriquecimiento obtenido y el empobrecimiento sufrido.",
    example: "Al haber realizado mejoras útiles en el inmueble ajeno por valor de Bs. 80,000 sin contrato, el demandante ejerce la acción de enriquecimiento sin causa conforme al Art. 961 del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 80, articles: ["961", "962", "963", "964", "965"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 10 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
      { law: "Constitución Política del Estado", shortName: "CPE", percentage: 5 },
    ],
    relatedTerms: ["indemnizacion", "responsabilidad-civil"],
  },
  {
    id: "interdicto",
    term: "Interdicto",
    category: "procesal",
    simpleDefinition: "Acción judicial rápida para proteger la posesión de un bien. Si alguien te quita tu terreno o te molesta en tu posesión, puedes usar un interdicto sin tener que probar que eres dueño.",
    legalDefinition: "Acción posesoria sumaria destinada a la tutela de la posesión o tenencia actual de bienes, independientemente del derecho de propiedad. Puede ser de retener (ante perturbaciones), de recobrar (ante despojo), de obra nueva o de daño temido.",
    example: "El demandante interpone interdicto de recobrar la posesión del terreno del cual fue despojado violentamente, solicitando la restitución inmediata conforme al Art. 1461 del Código Civil.",
    etymology: "Del latín 'interdictum', orden o prohibición del pretor romano.",
    lawPresence: [
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 50, articles: ["594", "595", "596", "600", "610", "620"] },
      { law: "Código Civil", shortName: "CC", percentage: 40, articles: ["1461", "1462", "1463", "1464"] },
      { law: "Constitución Política del Estado", shortName: "CPE", percentage: 10 },
    ],
    relatedTerms: ["posesion", "accion-reivindicatoria", "derecho-real"],
  },
  {
    id: "lesion",
    term: "Lesión (Enorme)",
    category: "contratos",
    simpleDefinition: "Cuando en un contrato una parte recibe mucho menos de lo que vale lo que entrega (ej: vender algo que vale 100,000 por solo 30,000). La parte perjudicada puede pedir anular o reajustar el contrato.",
    legalDefinition: "Vicio objetivo del contrato oneroso que se configura cuando existe desproporción manifiesta entre las prestaciones recíprocas al momento de la celebración, excediendo los límites legales, que faculta a la parte perjudicada a demandar la rescisión o el reajuste equitativo.",
    example: "El contrato es rescindible por lesión, al haberse demostrado que el precio de $us. 15,000 no alcanza a la mitad del valor real del inmueble tasado en $us. 80,000, conforme al Art. 561 del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 85, articles: ["561", "562", "563", "564"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
      { law: "Constitución Política del Estado", shortName: "CPE", percentage: 5 },
    ],
    relatedTerms: ["rescision", "nulidad", "anulabilidad", "compraventa"],
  },
  {
    id: "medida-cautelar",
    term: "Medida Cautelar",
    category: "procesal",
    simpleDefinition: "Orden del juez durante un juicio para proteger los bienes o derechos en disputa mientras se espera la sentencia. Por ejemplo, congelar cuentas bancarias o prohibir la venta de un inmueble.",
    legalDefinition: "Providencia jurisdiccional de carácter provisional, instrumental y urgente, dictada para asegurar la eficacia del resultado del juicio mediante la conservación del estado de hecho o de derecho, la prevención del daño o la anticipación provisional de la tutela.",
    example: "Se decreta como medida cautelar la anotación preventiva de la demanda sobre el inmueble inscrito en Derechos Reales, a fin de garantizar las resultas del presente proceso.",
    lawPresence: [
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 50, articles: ["310", "311", "312", "313", "314", "315", "316", "325"] },
      { law: "Código Civil", shortName: "CC", percentage: 20 },
      { law: "Código de Comercio", shortName: "CCom", percentage: 15 },
      { law: "Código Penal", shortName: "CP", percentage: 10 },
      { law: "Código de las Familias", shortName: "CF", percentage: 5 },
    ],
    relatedTerms: ["embargo", "sentencia", "cosa-juzgada"],
  },
  {
    id: "obligacion-solidaria",
    term: "Obligación Solidaria",
    category: "obligaciones",
    simpleDefinition: "Cuando varios deudores deben lo mismo, el acreedor puede cobrar la totalidad a cualquiera de ellos, no solo su parte proporcional. El que paga puede después cobrar a los demás su parte.",
    legalDefinition: "Modalidad de la obligación con pluralidad de sujetos en virtud de la cual cada codeudor (solidaridad pasiva) está obligado al pago íntegro de la prestación frente al acreedor, sin perjuicio de las relaciones internas de contribución entre los coobligados.",
    example: "Los codeudores solidarios se obligan al pago íntegro de la deuda, pudiendo el acreedor dirigir su acción contra cualquiera de ellos por la totalidad, conforme al Art. 433 del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 70, articles: ["433", "434", "435", "436", "437", "438", "439", "440", "441", "447"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 15 },
      { law: "Ley General del Trabajo", shortName: "LGT", percentage: 5 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
    ],
    relatedTerms: ["fianza", "indemnizacion", "subrogacion"],
  },
  {
    id: "pacto-comisorio",
    term: "Pacto Comisorio",
    category: "contratos",
    simpleDefinition: "Cláusula que permite dar por terminado un contrato automáticamente si la otra parte no cumple, sin necesidad de ir al juez.",
    legalDefinition: "Cláusula resolutoria, expresa o tácita, incorporada a contratos bilaterales, en virtud de la cual el incumplimiento de una parte faculta a la otra para resolver el contrato, operando de pleno derecho cuando es expresa o requiriendo intimación cuando es tácita.",
    example: "En caso de que el comprador incumpla el pago de dos cuotas consecutivas, el contrato quedará resuelto de pleno derecho en virtud del pacto comisorio expreso, conforme al Art. 568 del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 80, articles: ["568", "569", "570", "571", "572", "573", "574"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 10 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
    ],
    relatedTerms: ["resolucion", "incumplimiento", "clausula-penal", "mora"],
  },
  {
    id: "servidumbre",
    term: "Servidumbre",
    category: "derechos_reales",
    simpleDefinition: "Carga impuesta sobre un terreno en beneficio de otro terreno vecino. El ejemplo más común es el derecho de paso: cruzar por el terreno de otro para llegar al tuyo.",
    legalDefinition: "Derecho real sobre cosa ajena que grava un inmueble (predio sirviente) en beneficio de otro inmueble (predio dominante), imponiéndole limitaciones al ejercicio del dominio consistentes en tolerar ciertos actos o abstenerse de ejercer determinadas facultades.",
    example: "Se constituye servidumbre de paso a favor del predio dominante, debiendo el propietario del predio sirviente tolerar el tránsito por una franja de 3 metros, conforme a los Arts. 255 y siguientes del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 80, articles: ["255", "256", "257", "258", "259", "260", "270", "280", "289"] },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 10 },
      { law: "Constitución Política del Estado", shortName: "CPE", percentage: 5 },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
    ],
    relatedTerms: ["derecho-real", "usufructo", "hipoteca"],
  },
  {
    id: "transaccion",
    term: "Transacción",
    category: "procesal",
    simpleDefinition: "Acuerdo entre las partes de un conflicto en el que ambas ceden algo para terminar la disputa de manera amistosa, sin esperar sentencia. Tiene fuerza de cosa juzgada.",
    legalDefinition: "Contrato por el cual las partes, haciéndose concesiones recíprocas, ponen fin a una controversia existente o previenen una futura, teniendo entre ellas la autoridad de cosa juzgada, siempre que verse sobre derechos disponibles.",
    example: "Las partes celebran transacción conforme a los Arts. 945 y siguientes del Código Civil, mediante la cual el demandante renuncia a daños y perjuicios y el demandado se obliga a pagar Bs. 100,000 en seis meses, poniendo fin al litigio.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 60, articles: ["945", "946", "947", "948", "949", "950", "951", "952", "953", "954"] },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 25 },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
      { law: "Ley General del Trabajo", shortName: "LGT", percentage: 5 },
      { law: "Código de las Familias", shortName: "CF", percentage: 5 },
    ],
    relatedTerms: ["cosa-juzgada", "sentencia", "prescripcion"],
  },
  {
    id: "tradicion",
    term: "Tradición",
    category: "derechos_reales",
    simpleDefinition: "La entrega formal del bien del vendedor al comprador que completa la transferencia de propiedad. En inmuebles, se perfecciona con la inscripción en Derechos Reales.",
    legalDefinition: "Modo derivativo de adquisición del dominio que consiste en la entrega material o simbólica de la cosa por el tradente al adquirente. En bienes muebles perfecciona la transferencia; en inmuebles requiere inscripción en Derechos Reales para oponibilidad frente a terceros.",
    example: "La transferencia del derecho propietario se perfecciona con la inscripción en Derechos Reales, operando la tradición conforme al Art. 521 del Código Civil, surtiendo efectos frente a terceros desde la inscripción.",
    etymology: "Del latín 'traditio', entrega o transmisión.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 80, articles: ["110", "521", "522", "523", "524"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 10 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
      { law: "Constitución Política del Estado", shortName: "CPE", percentage: 5 },
    ],
    relatedTerms: ["derecho-real", "compraventa", "eviccion"],
  },
  {
    id: "titulo-ejecutivo",
    term: "Título Ejecutivo",
    category: "procesal",
    simpleDefinition: "Documento que contiene una deuda clara, con monto definido y plazo vencido, que permite al acreedor ir directo a un proceso de cobro rápido sin juicio ordinario. Ejemplos: pagarés, sentencias firmes.",
    legalDefinition: "Documento que reúne los requisitos legales de liquidez, exigibilidad y fuerza ejecutiva otorgada por ley, que habilita al acreedor a promover directamente el proceso ejecutivo sin necesidad de declaración previa del derecho.",
    example: "El pagaré debidamente llenado, firmado y con vencimiento cumplido constituye título ejecutivo conforme al Art. 378 del Código Procesal Civil, habilitando el proceso ejecutivo por vía de apremio.",
    lawPresence: [
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 50, articles: ["378", "379", "380", "381", "382", "383", "403"] },
      { law: "Código Civil", shortName: "CC", percentage: 20 },
      { law: "Código de Comercio", shortName: "CCom", percentage: 20 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
      { law: "Ley General del Trabajo", shortName: "LGT", percentage: 5 },
    ],
    relatedTerms: ["titulo-valor", "sentencia", "embargo", "prescripcion"],
  },
  {
    id: "reconvencion",
    term: "Reconvención",
    category: "procesal",
    simpleDefinition: "La 'contrademanda' que el demandado presenta contra el demandante dentro del mismo juicio. Es como decir: 'no solo me defiendo, sino que yo también te reclamo algo'.",
    legalDefinition: "Pretensión autónoma formulada por el demandado contra el demandante en el acto de contestación de la demanda, acumulándose al proceso principal para ser resuelta en la misma sentencia, siempre que exista conexión con la acción principal.",
    example: "El demandado, al contestar la demanda de cumplimiento de contrato, reconviene al demandante por daños y perjuicios derivados del incumplimiento parcial de las obligaciones del actor.",
    etymology: "Del latín 'reconventio', acción en contra.",
    lawPresence: [
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 80, articles: ["130", "347", "348", "349"] },
      { law: "Código Civil", shortName: "CC", percentage: 10 },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
      { law: "Ley General del Trabajo", shortName: "LGT", percentage: 5 },
    ],
    relatedTerms: ["sentencia", "cosa-juzgada", "litispendencia"],
  },
  {
    id: "remision-de-deuda",
    term: "Remisión de Deuda",
    category: "obligaciones",
    simpleDefinition: "Cuando el acreedor perdona la deuda al deudor, total o parcialmente, de manera voluntaria. Es como una donación de la deuda.",
    legalDefinition: "Modo de extinción de las obligaciones por el cual el acreedor renuncia voluntaria y gratuitamente a su derecho crediticio, liberando al deudor de la prestación debida, total o parcialmente.",
    example: "El acreedor concede la remisión total de la deuda de Bs. 50,000, liberando al deudor de toda obligación de pago conforme al Art. 372 del Código Civil.",
    lawPresence: [
      { law: "Código Civil", shortName: "CC", percentage: 85, articles: ["372", "373", "374", "375", "376", "377", "378", "379"] },
      { law: "Código de Comercio", shortName: "CCom", percentage: 5 },
      { law: "Ley de Servicios Financieros", shortName: "LSF", percentage: 5 },
      { law: "Código Procesal Civil", shortName: "CPC", percentage: 5 },
    ],
    relatedTerms: ["compensacion", "novacion", "donacion"],
  },
